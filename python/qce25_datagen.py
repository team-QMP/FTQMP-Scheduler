...
gen_cuboid_dataset(dinfos=[[1, 200], [2, 20], [3, 20], [4, 20], [5, 20], [6, 20]], req_interval=0, out_dir="dataset/A", num=20)
gen_cuboid_dataset(dinfos=[[1, 20], [2, 200], [3, 20], [4, 20], [5, 20], [6, 20]], req_interval=0, out_dir="dataset/B", num=20)
gen_cuboid_dataset(dinfos=[[1, 20], [2, 20], [3, 200], [4, 20], [5, 20], [6, 20]], req_interval=0, out_dir="dataset/C", num=20)
gen_cuboid_dataset(dinfos=[[1, 20], [2, 20], [3, 20], [4, 200], [5, 20], [6, 20]], req_interval=0, out_dir="dataset/D", num=20)
gen_cuboid_dataset(dinfos=[[1, 20], [2, 20], [3, 20], [4, 20], [5, 200], [6, 20]], req_interval=0, out_dir="dataset/E", num=20)
gen_cuboid_dataset(dinfos=[[1, 20], [2, 20], [3, 20], [4, 20], [5, 20], [6, 200]], req_interval=0, out_dir="dataset/F", num=20)
gen_cuboid_dataset(dinfos=[[1, 50], [2, 50], [3, 50], [4, 50], [5, 50], [6, 50]], req_interval=0, out_dir="dataset/G", num=20)
gen_cuboid_dataset(dinfos=[[1, 90], [2, 90], [3, 90], [4, 10], [5, 10], [6, 10]], req_interval=0, out_dir="dataset/H", num=20)
gen_cuboid_dataset(dinfos=[[1, 10], [2, 10], [3, 10], [4, 90], [5, 90], [6, 90]], req_interval=0, out_dir="dataset/I", num=20)
